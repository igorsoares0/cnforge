...
export default function Login5({
  ...
  signupHref = "#",
  trustNote = "We'll email you a link that signs you in instantly.",
}: Login5Props) {
  return (
    <section className="flex min-h-[80vh] w-full items-center justify-center bg-background px-4 py-16">
      <div className="w-full max-w-sm">
        ...
        <div className="mt-8 flex flex-col gap-3">
          <button
            type="button"
            className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-lg border border-border bg-card text-sm font-medium text-foreground transition-colors hover:bg-muted"
          >
        ...
        >
          <div className="flex flex-col gap-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                autoComplete="email"
                className="h-11 w-full rounded-lg border border-border bg-card pl-10 pr-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-foreground/20"
          ...
          <Button
            type="submit"
            size="lg"
            className="h-11 w-full rounded-lg bg-primary text-sm text-primary-foreground hover:opacity-90"
          >
            {submitLabel}
