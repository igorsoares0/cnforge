...
export default function Footer3({
  brand = "Forge",
  brandHref = "#",
  description = "Production-ready UI blocks for React and Next.js.",
        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-5 lg:gap-12">
          <div className="flex flex-col gap-4 lg:col-span-2">
            ...
            <div className="mt-2">
              ...
              >
                <label className="sr-only" htmlFor="footer3-email">
                  Email
                </label>
                <input
                  id="footer3-email"
                  ...
                  className="h-9 w-full max-w-[220px] rounded-lg border border-border bg-card px-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-foreground/20"
                />
                <Button
                  type="submit"
