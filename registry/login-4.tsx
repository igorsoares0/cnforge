...
export default function Login4({
  brand = "Forge",
  panelTitle = "Build landing pages at the speed of thought",
  panelSubtitle = "100+ production-ready blocks. 8 themes. Zero runtime dependencies.",
  testimonial = {
    quote: "We shipped our entire marketing site in a single sprint. The blocks are incredibly well-crafted.",
    author: "Maya Chen",
    role: "VP Engineering at Verve",
    initials: "MC",
  },
  title = "Welcome back",
  ...
  return (
    <section className="flex min-h-[80vh] w-full bg-background">
      <div className="hidden w-1/2 flex-col justify-between bg-card p-10 lg:flex xl:p-14">
        ...
        <figure className="rounded-xl border border-border bg-background p-6">
          <blockquote className="text-sm leading-6 text-foreground">
            &ldquo;{testimonial.quote}&rdquo;
          </blockquote>
          <figcaption className="mt-4 flex items-center gap-3">
            <span className="inline-flex size-9 items-center justify-center rounded-full bg-emerald-500 text-xs font-semibold text-white">
