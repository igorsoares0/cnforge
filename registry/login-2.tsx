...
export default function Login2({
  brand = "Forge",
  tagline = "Ship faster with production-ready UI blocks.",
  testimonial = "Forge saved us weeks of frontend work. The blocks are polished, responsive, and just work out of the box.",
  testimonialAuthor = "Ana Torres",
  testimonialRole = "CTO at Acme",
  title = "Sign in",
  ...
  return (
    <section className="flex min-h-[80vh] w-full bg-background">
      <div className="hidden w-1/2 flex-col justify-between bg-primary p-10 lg:flex">
        <a
          href="#"
          className="flex items-center gap-2 text-base font-semibold tracking-tight text-primary-foreground"
        >
          <span
            className="inline-flex size-8 items-center justify-center rounded-lg bg-primary-foreground text-sm font-bold text-primary"
        ...
        <p className="text-sm text-primary-foreground/60">{tagline}</p>
      </div>
