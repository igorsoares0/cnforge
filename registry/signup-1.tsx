...
const DEFAULT_FEATURES = [
  "75+ production-ready blocks",
  "8 theme palettes included",
...
export default function Signup1({
  ...
  subtitle = "Create your account and ship your first page in minutes.",
  formAction = "#",
  formMethod = "POST",
  ...
  return (
    <section className="flex min-h-[80vh] w-full items-center justify-center bg-background px-4 py-16">
      <div className="mx-auto grid w-full max-w-5xl grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-20">
        <div className="hidden flex-col justify-center lg:flex">
          ...
          <h1
            className="mt-8 text-4xl tracking-tight text-foreground"
            style={{
